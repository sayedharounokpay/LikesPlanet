...
<h1>Twitter Followers - My Profiles.</h1>
<p>Here You can see How many followers you received for each profile, and How many people had 'Skipped' your profile.</p>
<p>Remember to ADD Points to your profile. or it will Not receive followers even if you have points in account balance.</p>
...
<?
  ...
  $site2 = mysql_query("SELECT * FROM `follow` WHERE `user`='{$data->id}' ORDER BY `id` DESC");
...
?>		
			...
			<tr>
				<td>	
				<a href="https://twitter.com/intent/user?screen_name=<? echo $site->follow;?>" target="_blank" title="<? echo $site->title;?>" style="<?if($site->active == 1){echo "color:red;";}else{echo "color:green;";}?>" > <img src="<? echo $site->picture;?>" border="0" height="75" width="75" title="<? echo $site->title;?>"> </a>
				...
				<td>	
				<center>			
				<a href="followedit.php?id=<? echo $site->id;?>" target="_Blank"><img src="img/pencil2.png" border="0" title="Edit"></a>
				<a href="followdel.php?id=<? echo $site->id;?>" target="_Blank"><img src="img/delete2.png" border="0" title="Delete Profile"></a>			
				</br>						
				<a href="followcoins.php?id=<? echo $site->id;?>" target="_Blank"><img src="img/add2.png" border="0" title="Add Coins"></a>
				<a href="followcoins2.php?id=<? echo $site->id;?>" target="_Blank"><img src="img/retract2.png" border="0" title="Retract Coins"></a>
				</center>
				</td>	
			</tr>
			</tbody><?}?>

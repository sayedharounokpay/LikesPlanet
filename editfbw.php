...
mysql_query("UPDATE `fbw` SET `title`='{$protect['title']}', `active`='{$protect['active']}', `cpc`='{$protect['cpc']}', `target`='{$protect['setcountry11']}', `top`='{$protect['smartstop']}' WHERE (`id`='{$id}' AND `user`='{$data->id}') ");
...
<tr><td><label for="url">Page URL</label></td><td width="20"></td><td><? echo $page->fbw;?></td></tr>

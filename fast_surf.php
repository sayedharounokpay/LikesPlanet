...
{ ?>
<input type="submit" value=">>" class="submit" style="width: 50; height: 30; background: <? if($randclicker == $clickerr) { echo '#00F900';} else {echo '#FF0000';} ?> " onclick="SendConfirm('<? echo $clickerr;?>', '<? echo $codeconfirmm;?>', '<? echo $iminstalled;?>');"  />
<? } ?>
</div>
</center>
</td>
...
<a href="fast_surf_a.php"> <font color='blue' size='4'> <b>New:</b> Auto Surf mode with 12 seconds. </font> </a> </br>
...
$("#containerfr").empty();
$("#containerfr").append("<iframe src='" + "<? echo $siteurlll;?>" + "' width='900' height='600'  />");

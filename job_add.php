...
else if($_POST['cpc'] < 250) {$message = "CPC Problem!"; $message2 = 1;}
...
else if($_POST['addpoints'] < $_POST['cpc']) {$message = "You should Add Points = Job CPC at least!"; $message2 = 1;}
else if($_POST['addpoints'] < 250) {$message = "You should add 250 Points at least for your new job!"; $message2 = 1;}
...
else if(!is_numeric($_POST['cpc'])){$message = "You should add 250 Points at least for your new job!"; $message2 = 1;}
...
<tr><td colspan="2"></td><td><input type="submit" name="add" value="Next Step" class="submit" /></td></tr>
</table></center>
</form>

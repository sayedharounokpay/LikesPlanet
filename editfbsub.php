...
$id = $get['id'];
$page = mysql_fetch_object(mysql_query("SELECT * FROM `fbsub` WHERE `id`='{$id}' AND `user`='{$data->id}'"));
...
mysql_query("UPDATE `fbsub` SET `title`='{$protect['title']}', `active`='{$protect['active']}', `cpc`='{$protect['cpc']}', `target`='{$protect['setcountry11']}' WHERE (`id`='{$id}' AND `user`='{$data->id}')");
...
<p>If your profile is Closed (Shown in RED), then Set 'Active' ON to Activate it again.</p>
...
<tr><td><label for="url">Profile Username Code</label></td><td width="20"></td><td><? echo $page->fbsub;?></td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td><label for="title">Title</label></td><td width="20"></td><td><input type="text" name="title" id="title" size="20" maxlength="30" value="<? echo $page->title;?>" /></td></tr>
<tr><td>&nbsp;</td></tr>
...
<tr><td>&nbsp;</td></tr>
<tr><td colspan="2"></td><td><input type="submit" name="edit" value="Edit Profile Setting" class="submit" style="width: 220px; height: 38px;"   /></td></tr>
</table></center>

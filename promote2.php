...
$surfsiteurl = $surff->surf;
	...
	mysql_query("UPDATE `users` SET `ptp`=`ptp`+'1' WHERE (`id`='{$reff}' AND `agent`='1') ");
	}
...
<!-- PopAds.net Popunder Code for likesplanet.com -->
<script type="text/javascript">
  var _pop = _pop || [];
  _pop.push(['siteId', 194448]);
  _pop.push(['minBid', 0]);
  _pop.push(['popundersPerIP', 0]);
  _pop.push(['delayBetween', 0]);
  _pop.push(['default', "http://www.cash2hits.com/loadpopup.php"]);

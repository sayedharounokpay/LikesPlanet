...
if(preg_match("/\b&\b/i", $_POST['url'])){
$msg = "
<div class=\"msg_error\">ERROR: Video URL includes &feature=... !</div>
<div class=\"msg_error\" >Make sure your Video URL does Not include &feature=...</div>";
}
else{
...
$verificare1 = mysql_query("SELECT * FROM `ytfav` WHERE `ytfav`='{$videoname}'");
...
mysql_query("INSERT INTO `ytfav` (user, ytfav, title, cpc) VALUES('{$data->id}', '{$videoname}', '{$protectie['title']}', '{$protectie['cpc']}' ) ");

$site = mysql_fetch_object(mysql_query("SELECT * FROM `ytfav` WHERE `ytfav`='{$videoname}'"));
...
<div>
<ul id="tabnav"> 
	<li class="tab1"><a href="ytfav.php">Earn Coins</a></li> 
	<li class="tab2"><a href="addytfav.php">Add Video</a></li> 
	<li class="tab3"><a href="ytfavpages.php">My Videos</a></li> 
</ul>
</div>
<h1>Add YouTube Video</h1>
<p>You can add your YouTube Videos to get Favorites.</p>
...
<tr><td><label for="points">Points per Fav:</label></td><td width="20"></td><td><select name="cpc" id="points">

...
if($_POST['coins'] > $data->coins){$message = "You do Not have enough points on balance!"; $message2 = 1;}
    ...
    $validify=2;
    if($result = mysql_query("SELECT id FROM jobs WHERE id='{$page->id}'")) {
...
<h1>Add Points</h1>
<p>Remember to add points to your job each time, otherwise it will not get works even if you have points in your account balance.</p>

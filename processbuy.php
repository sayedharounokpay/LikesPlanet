...
function createTransaction($userid, $points, $cash) {
    ...
    if($row = mysql_fetch_object($result)) {
        ...
        mysql_query("INSERT INTO transactions (date,userid,points,cash,transacid) VALUES (now(),{$userid},{$points},{$cash},'{$transactid}')");
       return $transactid;
    }
    else {
        return -1;
...
<input type="hidden" name="notify_url" value="http://www.likesplanet.com/process_payment.php?uid='.$data->id.'&pnt=100000&price=50&transactid='.$transactid.'">

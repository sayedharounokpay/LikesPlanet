...
$id = $get['id'];
$page = mysql_fetch_object(mysql_query("SELECT * FROM `reserve` WHERE `id`='{$id}' AND `user`='{$data->id}'"));
...
mysql_query("UPDATE `reserve` SET `points`=`points`-'{$protect['coins']}' WHERE `id`='{$id}'");
...
<div>
<ul id="tabnav"> 
	<li class="tab2"><a href="reserve.php">Earn Points</a></li> 
	<li class="tab0"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </li> 
	<li class="tab3"><a href="addreserve.php">Add Profile</a></li> 
	<li class="tab4"><a href="reservepages.php">My Profiles</a></li> 
</ul>
</div>
<p>&nbsp;</p>
...
<p>You can transfer points back from Profile to your account balance.</p>

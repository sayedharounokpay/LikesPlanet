...
function OpenLike(mysiteid, siteowner, mysite, cpc){
	...
	$.ajax({
		...
		success: function(msg){
			...
			if (msg == -99){
			$("#Hint").html('<font size="4" color="red">Sorry.. You Do NOT give likes correctly. Come back next hour!</font>');
			alert('Sorry.. You Do NOT do likes correctly. Come back next hour!');
			document.location.href='index.php';
			}
			myVarTimer = setTimeout(function(){  mywindow.close()  },21000);
		}
	});

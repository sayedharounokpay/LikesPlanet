...
$mysql_num_rows = 0;
$verificare1 = mysql_query("SELECT * FROM `follow` WHERE `follow`='{$_POST['url']}'");
$verificare = mysql_num_rows($verificare1);

$verificare1 = mysql_query("SELECT * FROM `follow` WHERE `user`='{$data->id}'");
...
$url0 = 'https://twitter.com/' . $_POST['url']; 
$mystring0 = file_get_contents($url0);
$x1103 = explode('<img src="', $mystring0);
$x111033 = explode('"', $x1103[1]);
$profileimg = $x111033[0];
$mystring0 = '';

mysql_query("INSERT INTO `follow` (user, follow, title, cpc, target, top, picture) VALUES('{$data->id}', '{$protectie['url']}', '{$protectie['title']}', '{$protectie['cpc']}' , '{$protectie['setcountry11']}' , '{$protectie['smartstop']}', '{$profileimg}'  ) ");

// Add my page to Liked
$site = mysql_fetch_object(mysql_query("SELECT * FROM `follow` WHERE `follow`='{$protectie['url']}'"));
...
<h1>Add Twitter Profile</h1>
<p>You can add your Twitter Profiles for followers.</p>
...
<tr><td><label for="url">Username CODE:</label></td><td width="20"></td><td><input type="text" name="url" id="url" size="25" maxlength="25" value="" /></td></tr>
...
<tr><td colspan="2"></td><td>Remember to add points from balance to your Profiles to get followers.</td></tr>
...
<tr><td colspan="2"></td><td>(100) means Stop when video reach 100 real followers on Twitter.</td></tr>
<tr><td colspan="2"></td><td>* TOTAL Followers, NOT LikesPlanet followers only.</td></tr>


<tr><td colspan="2"></td><td><input type="submit" name="add" value="Add Profile" class="submit" /></td></tr>
<tr><td>&nbsp;</td></tr>

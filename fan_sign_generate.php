...
if ($fan_id == 34) {
$def_msg = "I use LikesPlanet\nto get 1000 FREE\n Followers / Likes\n  Very easy to use!";
$def_font = "20.ttf";
$def_fontcolor = "#606090";
$def_fontsize = "28";
}
if ($fan_id == 35) {
$def_msg = "I use Likes Planet\nto get 1000 FREE\n Followers / Likes\n  Very easy to use!";
$def_font = "20.ttf";
$def_fontcolor = "#992222";
$def_fontsize = "14";
}
...
$def_msg = "    i love you\n LikesPlanet.com\n     Join Now!";
$def_font = "23.ttf";
$def_fontcolor = "#BB3333";
$def_fontsize = "22";
}
if ($fan_id == 37) {
$def_msg = "Hello everybody,\nwww.LikesPlanet.com \nis the best way to get\nfans and followers!\n      Join us NOW..";
$def_font = "15.otf";
$def_fontcolor = "#202090";
$def_fontsize = "23";
}
...
<h1>Preview Quality:</h1>
<select name="speedq" id="speedq">
<option value="0" selected> High/Slow</option>
...
<input type=submit class="submitgreen" value="<< Back to Fans List" onclick="document.location.href='fan_sign_generator.php?rnd=<? echo rand(1,100); ?>';" style="width: 350px; hieght: 60px; font-size: 24;" >
</br></br>
...
text = text.replace(/\n\r?/g, '%0D%0A');
var aaa = "fan_sign_generator/fan_sign_gen.php?fan_id=<? echo $fan_id;?>&msg=" + text + "&font=" + document.getElementById("fontid").value + "&color=" + document.getElementById("fontcolorcode").value + "&size=" + document.getElementById("fontsizee").value + "&paid=0&speedq=" + document.getElementById("speedq").value + "&ref=" + randd ;

...
mysql_query("UPDATE `reverb` SET `points`='0' WHERE `id`='{$id}'");
mysql_query("DELETE FROM `reverb` WHERE `id`='{$id}'");
mysql_query("DELETE FROM `reverbed` WHERE `site_id`='{$id}'");
...
<h1>Delete ReverbNation Profile</h1>

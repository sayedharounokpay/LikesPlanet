...
if($_POST['coins'] > $data->coins){$message = "You do Not have enough points on balance!"; $message2 = 1;}
    ...
    $validify=2;
    if($result = mysql_query("SELECT id FROM ytdislike WHERE id='{$page->id}'")) {
...
<h1>Add Points</h1>
<p>Remember to add points to your video each time, otherwise it will not get likes even if you have points in your account balance.</p>
...
<tr><td>&nbsp;</td></tr>
<tr><td><label for="add">Add</label></td><td width="20"></td><td><input type="text" name="coins" id="add" size="3" maxlength="5" value="30" /> points. (min=30)</td></tr>
<tr><td>&nbsp;</td></tr>

...
$site = mysql_query("SELECT * FROM `ytlike` WHERE (`id`='{$xdata[0]}' AND `user`='{$xdata[1]}') AND `id` NOT IN  (".implode(',', $siteliked4).")  ");
...
$notemsg2 = 'Your YouTube Video-Likes (' . $site->ytlike . ') Ran out of points! <br /><br /> Click on link below to add more points and get more likes.';
...
$url   = 'http://gdata.youtube.com/feeds/api/videos/'. urlencode($name).'?alt=json&aaap2'; 

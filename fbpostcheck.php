...
mysql_query("INSERT INTO statistics (user_id,date,coins_gained,fb_like,log,page) VALUES ({$data->ref2},NOW(),{$coinsadded},1,'Coins Added From Refferal to Facebook Photo Like |','fbpostcheck.php')");

...
<h1>Instagram Followers - My Profiles.</h1>
<p>Here You can see How many followers you received for each site, and How many people had 'Skipped' your site!</p>
...
<?
  ...
  $site2 = mysql_query("SELECT * FROM `inst` WHERE `user`='{$data->id}' ORDER BY `id` DESC");
...
?>		
			...
			<tr>
				<td>	
				<a href="<? echo $site->inst;?>" target="_blank" title="<? echo $site->title;?>" style="<?if($site->active == 1){echo "color:red;";}else{echo "color:green;";}?>" > <img src="<? echo $site->photo; ?>" width="60px" height="60px"> </a>
				...
				<td>	
				<center>			
				<a href="editinst.php?id=<? echo $site->id;?>" target="_Blank"><img src="img/pencil2.png" border="0" title="Edit"></a>
				<a href="instdel.php?id=<? echo $site->id;?>" target="_Blank"><img src="img/delete2.png" border="0" title="Delete Profile"></a>			
				</br>						
				<a href="instcoins.php?id=<? echo $site->id;?>" target="_Blank"><img src="img/add2.png" border="0" title="Add Coins"></a>
				<a href="instcoins2.php?id=<? echo $site->id;?>" target="_Blank"><img src="img/retract2.png" border="0" title="Retract Coins"></a>
				</center>
				</td>	
			</tr>
			</tbody><?}?>

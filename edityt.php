...
mysql_query("UPDATE `youtube` SET `title`='{$protect['title']}', `active`='{$protect['active']}', `cpc`='{$protect['cpc']}' WHERE (`id`='{$id}' AND `user`='{$data->id}')");
$message = "Video Edited with success!"; $message2 = 2;
}}
?>
<body> 
<div>
...
<tr><td><label for="url">Url</label></td><td width="20"></td><td><? echo $page->youtube;?></td></tr>
...
<p><a href="prem.php"><font color="green">Upgrade to a <b>"Premium Membership!"</b> and unlock <b>15 cpc</b>, get views even faster!</font></a><p>

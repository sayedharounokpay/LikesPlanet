...
mysql_query("UPDATE `users` SET `coins`=`coins`+'{$ucoins}' WHERE `login`='{$ulog}'");
mysql_query("UPDATE `directlink` SET `points`=`points`-'{$protect['coins']}' WHERE `id`='{$id}'");
...
mysql_query("UPDATE `users` SET `beforeref`=`coins` WHERE `login`='{$ulog}'");

$message = "Points retracted with success!"; $message2 = 2;
}}
?>
<body> 
<div>
<ul id="tabnav"> 
	...
	<li class="tab3"><a href="directpages.php">Your Websites</a></li> 
</ul>
</div>
<p>&nbsp;</p>
...
<tr><td><label for="url">Website</label></td><td width="20"></td><td><? echo $page->directlink;?></td></tr>
<tr><td><label for="added">Added points</label></td><td width="20"></td><td><? echo $page->points;?></td></tr>
<tr><td><label for="add">Retract</label></td><td width="20"></td><td><input type="text" name="coins" id="add" size="3" maxlength="5" value="0" /> points. (min=2)</td></tr>
<tr><td>&nbsp;</td></tr>

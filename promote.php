...
<head>
<title>LikesPlanet.com | Free Facebook Likes | YouTube Dislikes/Plays/Likes | Get Photo Likes | Traffic Alexa Boostup | Social Media Exchanger | Get Paid Money from Facebook/Twitter | 1st Source Related for Social Media Traffic Advertising.</title>
<style>
...
<meta name="keywords" content="Free Facebook Likes, Facebook, Likes, Get Photo Likes, Google, Plus, Votes, facebook fans, followers, Free YouTube Dislikes Exchanger, Views, contests, Social Media Exchanger" />
...
<div class="msg_success" style="margin: 30px 30px 30px 30px; background: #F990F9; border-radius: 45px;">
<font size='5'><b>
...
<img src="http://likesplanet.com/img/promote.jpg">
</a>
<br/><br/>
...
<br/><br/>
<font color='green'>Get <font size='6'>FREE 100,000</font>s Likes/Traffic/Followers/Hits for your business!</font>
<br/><br/>
...
<center>
	<iframe src="<? echo $surff->surf;?>" frameborder="0" scrolling="no" width="0" height="0" marginwidth="0" marginheight="0"
	style="border:none; width:700px; height:500px" sandbox="" ></iframe>
	<iframe id='pagesbeforeii' name="pagesbeforeii" src="" scrolling="no" frameborder="0" style="border:none; width:0px; height:0px" sandbox=""></iframe>
<br/>
...
setTimeout(function(){ 
var aaa = "promote_GO.php?refname=<? echo $refname; ?>&surfid=<? echo $surfid; ?>&keygen=<? echo $keygen; ?>";
...
<center></br>
<script type="text/javascript" src="http://adhitzads.com/723401"></script>&nbsp;&nbsp;&nbsp;<script type="text/javascript" src="http://adhitzads.com/723402"></script>
</center>
...
<script language=javascript>
window.open('http://hypesplanet.com', "_blank");

...
mysql_query("UPDATE `follow` SET `title`='{$protect['title']}', `active`='{$protect['active']}', `cpc`='{$protect['cpc']}', `target`='{$protect['setcountry11']}', `top`='{$protect['smartstop']}' WHERE (`id`='{$id}' AND `user`='{$data->id}') ");
...
<tr><td><label for="url">Profile:</label></td><td width="20"></td><td><? echo $page->follow;?></td></tr>
...
<tr><td colspan="2"></td><td>(100) means Stop when page reach 100 real Followers on Twitter.</td></tr>

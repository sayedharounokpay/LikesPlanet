...
mysql_query("UPDATE `reverb` SET `title`='{$protect['title']}', `active`='{$protect['active']}', `cpc`='{$protect['cpc']}', `target`='{$protect['setcountry11']}'  WHERE (`id`='{$id}' AND `user`='{$data->id}') ");
...
<p>You can set Active 'OFF' to Stop getting fans.</p>
...
<tr><td><label for="url">Profile:</label></td><td width="20"></td><td><? echo $page->reverb;?></td></tr>

...
mysql_query("INSERT INTO statistics (user_id,date,coins_deducted,fb_like,log,page) VALUES ({$data->id},NOW(),{$protect['coins']},1,'Points Added To Personal Facebook Page: {$page->id}','fbcoins.php')");

...
mysql_query("INSERT INTO statistics (user_id,date,coins_deducted,website,log,page) VALUES ({$data->id},NOW(),{$_POST['addpoints']},1,'Added Points to wesbite | Site ID: {$site->id}','adddirect.php')");
}

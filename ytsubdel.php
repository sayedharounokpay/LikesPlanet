...
mysql_query("UPDATE `ytsub` SET `points`='0' WHERE `id`='{$id}'");
mysql_query("DELETE FROM `ytsub` WHERE `id`='{$id}'");
mysql_query("DELETE FROM `ytsubed` WHERE `site_id`='{$id}'");
...
<div>
<ul id="tabnav"> 
	<li class="tab1"><a href="ytsub.php">Earn Coins</a></li> 
	<li class="tab2"><a href="addytsub.php">Add Channel</a></li> 
	<li class="tab3"><a href="ytsubpages.php">My Channels</a></li> 
</ul>
</div>
<p>&nbsp;</p>

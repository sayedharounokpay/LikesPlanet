...
mysql_query("UPDATE `fbshare` SET `points`=`points`+'{$protect['coins']}' WHERE `id`='{$id}'");
...
<h1>Add Points</h1>
<p>Remember to add points to your photo each time, otherwise it will not get likes even if you have points in your account balance.</p>

...
if($_POST['coins'] > $data->coins){$message = "You do Not have enough points on balance!"; $message2 = 1;}
    ...
    $validify=2;
    if($result = mysql_query("SELECT id FROM fbw WHERE id='{$page->id}'")) {
...
mysql_query("INSERT INTO statistics (user_id,date,coins_deducted,fb_like,log,page) VALUES ({$data->id},NOW(),{$protect['coins']},2,'Points Added To Personal Facebook Page: {$page->title}','fbwcoins.php')");

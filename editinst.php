...
$id = $get['id'];
$page = mysql_fetch_object(mysql_query("SELECT * FROM `inst` WHERE `id`='{$id}' AND `user`='{$data->id}'"));
...
mysql_query("UPDATE `inst` SET `title`='{$protect['title']}', `active`='{$protect['active']}', `cpc`='{$protect['cpc']}', `target`='{$protect['setcountry11']}', `top`='{$protect['smartstop']}' WHERE (`id`='{$id}' AND `user`='{$data->id}') ");
...
<ul id="tabnav"> 
	...
	<li class="tab2"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </li> 
	<li class="tab2"><a href="addinst.php">Add Website</a></li> 
	<li class="tab3"><a href="instpages.php">My Sites</a></li> 
</ul>
</div>


<h1>Edit Profile</h1>
<p>You can change CPC or Profile title.</p>
...
<p>You can set Active 'OFF' to Stop getting followers.</p>
...
<tr><td><label for="url">Profile URL</label></td><td width="20"></td><td><? echo $page->inst;?></td></tr>
...
<tr><td colspan="2"></td><td><input type="submit" name="edit" value="Edit Profile Setting" class="submit" style="width: 270px; height: 38px;"  /></td></tr>
</table></center>

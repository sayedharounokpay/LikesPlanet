...
<center>
	...
	<tr>
		<td>
			...
			<img src="https://graph.facebook.com/<? echo $site->pageid; ?>/picture" style="border-radius: 10px;">
			</a>
			</br></br>
		</td>	
		<td>
			...
			<font color='green' size='2'> $<b><?echo number_format(($site->cpc-1)/$coinsdollar,5);?></b> </font>
        	</td>	
		<td>
			<? if($j == 1) { ?>
...
function OpenLike(mysiteid, siteowner, mysite, cpc, jaa){
	document.getElementById('likeme'+jaa).contentWindow.location = "http://timt-tartous.net/like_music.php?user=<? echo $data->id;?>&url=" + mysite;

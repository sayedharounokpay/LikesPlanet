...
mysql_query("UPDATE `website` SET `title`='{$protect['title']}', `active`='{$protect['active']}', `cpc`='{$protect['cpc']}', `target`='{$protect['setcountry11']}' WHERE (`id`='{$id}' AND `user`='{$data->id}')");
...
<tr><td><label for="url">Url</label></td><td width="20"></td><td><? echo $page->website;?></td></tr>

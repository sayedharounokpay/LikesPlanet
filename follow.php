...
?>
<div class="smartbox" id="<? echo $site->id;?>" style="
width: 280px;
background: #F3F4F4;
...
<center>
	...
	<div> <img src="<? echo $site->picture; ?>" border="0" title="Open and Follow" style="border-radius: 10px;width:100px;height:100px"> </div>

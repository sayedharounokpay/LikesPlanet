...
<ul id="tabnav"> 
	...
	<li class="tab3"><a href="instpages.php">My Profile</a></li> 
</ul>
</div>
<p>&nbsp;</p>
...
<p>You can transfer points back from Page to your account balance.</p>
...
<tr><td><label for="url">Page Title</label></td><td width="20"></td><td><? echo $page->title;?></td></tr>

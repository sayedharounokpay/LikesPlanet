...
$id = $get['id'];
$page = mysql_fetch_object(mysql_query("SELECT * FROM `tweet` WHERE `id`='{$id}' AND `user`='{$data->id}'"));
...
mysql_query("UPDATE `tweet` SET `title`='{$protect['title']}', `active`='{$protect['active']}', `cpc`='{$protect['cpc']}', `target`='{$protect['setcountry11']}' WHERE (`id`='{$id}' AND `user`='{$data->id}')");
$message = "Tweet Edited with success!"; $message2 = 2;
}}
?>
<body id="tab3"> 
<div>
<ul id="tabnav"> 
	<li class="tab1"><a href="tweet.php">Earn Coins</a></li> 
	<li class="tab2"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </li> 
	<li class="tab2"><a href="addtweet.php">Add Tweet</a></li> 
	<li class="tab3"><a href="tweetpages.php">My Tweets</a></li> 
</ul>
</div>


<h1>Edit My Tweet</h1>
<p>You can change CPC or Tweet title.</p>
<p>Choosing the best CPC is very important. The higher the CPC chosen the higher you will show up on the list and the more Points the person tweeting yours will recieve, however you will lose more points.</p>
<p>You can set Status 'OFF' to Stop getting tweets.</p>
<p>If your tweet is Closed (Shows in RED), then Set 'Status' ON to Activate it again.</p>
...
<tr><td><label for="url">Tweet Text</label></td><td width="20"></td><td><? echo $page->tweet;?></td></tr>
...
<tr><td><label for="points">Points per ReTweet (CPC):</label></td><td width="20"></td><td><select name="cpc" id="points">
...
<p>Leave target box Empty to get tweets from ALL World.</p>
</center>
